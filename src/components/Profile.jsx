...
import { fetchLoggedInUserAsync, selectUserInfo, updateUserAsync } from '../features/user/UserSlice';
...
const Profile = () => {
    ...
    // ✅ Add guard to wait for userInfo
    if (!userInfo) {
    ...
    const handleAdd = (address) => {
        const newUser = {
            ...userInfo,
            addresses: userInfo.addresses ? [...userInfo.addresses, address] : [address],
        };
        dispatch(updateUserAsync(newUser));
